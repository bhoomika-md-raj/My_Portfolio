...
const PORTFOLIO = {
  ...
  tagline: "I build AI-driven diagnostics that turn raw medical signals — images, scans, ECG traces, lab values — into early, actionable health insight.",
  ...
  vitals: [
    ...
    { label: "Diagnostic Modules Built", value: "5", note: "Skin · X-ray · CT · ECG · Blood" }
  ],
