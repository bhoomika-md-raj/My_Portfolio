...
const PORTFOLIO = {
  ...
  // Add one block per design. "image" should be the exact filename of
  // a file sitting in the repo root next to index.html (e.g. "poster1.jpg"),
  // or a direct image URL. Leave image: "" to show an empty placeholder
  // until you add the file.
  works: [
    { title: "AyuSense — KSCST Poster Presentation", category: "Research Poster", image: "ayusense-kscst-poster.jpg" },
    { title: "AyuSense — Project Exhibition Poster", category: "Project Poster", image: "ayusense-exhibition-poster.jpg" },
    { title: "Tourism Promotion Through Innovative Approaches I", category: "Design Poster", image: "tourism-promotion-poster-1.jpg" },
    { title: "Tourism Promotion Through Innovative Approaches II", category: "Design Poster", image: "tourism-promotion-poster-2.jpg" }
  ],
